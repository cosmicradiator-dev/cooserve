...
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    // Fail-open for rate limiting to ensure API availability if limiter encounters network faults
    console.warn('[Middleware RateLimit Warning]', err instanceof Error ? err.message : err);
  }
